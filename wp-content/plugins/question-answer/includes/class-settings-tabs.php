...
class settings_tabs_field{
    ...
    public function field_media( $option ){
        ...
        <div id="input-wrapper-<?php echo $css_id; ?>" class="input-wrapper field-media-wrapper
            ...
            <div class="media-upload button" id="media_upload_<?php echo $css_id; ?>"><?php echo __('Upload','question-answer');?></div>
            <div class="clear button" id="media_clear_<?php echo $css_id; ?>"><?php echo __('Clear','question-answer');?></div>
    ...
    public function field_repeatable( $option ){
        ...
        <div id="input-wrapper-<?php echo $css_id; ?>" class=" input-wrapper field-repeatable-wrapper
            ...
            <div class="add-repeat-field button"><?php _e('Add','question-answer'); ?></div>
    ...
    public function field_text_multi( $option ){
        ...
        <div  id="input-wrapper-<?php echo $id; ?>" class="input-wrapper input-text-multi-wrapper
            ...
            <span data-placeholder="<?php echo esc_attr($placeholder); ?>" data-sort="<?php echo $sortable; ?>" data-clone="<?php echo $allow_clone; ?>" data-name="<?php echo $field_name; ?>[]" class="button add-item"><?php echo __('Add','question-answer'); ?></span>
