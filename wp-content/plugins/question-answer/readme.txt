...
= 1.2.38 =
* 25/09/2019 update - sort question archive by last update answer, comments

= 1.2.36 =
* 25/09/2019 fix - responsive issue on question submit form

= 1.2.35 =
* 5/07/2019 fix - PHP error issue fixed.
...
= 1.2.32 =
* 07/03/2019 fix - answer reply load more order issue fixed.

= 1.2.31 =
* 02/03/2019 add - answer reply order.

= 1.2.30 =
* 04/10/2018 fix - hide notification for non logged-in user

= 1.2.29 =
* 28/09/2018 fix - some minor php issue fixed.
* 28/09/2018 update - notification icon changed.


= 1.2.28 =
* 26/09/2018 add - Notification on single question page.
* 26/09/2018 add - add question button on single question page.
* 26/09/2018 add - back to archive button on single question page.
* 26/09/2018 add - Search button on single question page.
* 26/09/2018 add - Notification count is back.

= 1.2.27 =

* 24/09/2018 fix - Visitor posting answer issue fixed.


= 1.2.26 =

* 10/09/2018 fix - Adding poll issue fixed.

= 1.2.25 =

* 15/08/2018 re-write - Re-design question archive.


= 1.2.24 =

* 11/07/2018 fix - Error message for home page
