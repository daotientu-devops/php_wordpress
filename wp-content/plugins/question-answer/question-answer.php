...
class QuestionAnswer{
	...
	public function qa_admin_scripts(){
        ...
        // Register Scripts
        wp_register_script('settings_tabs', QA_PLUGIN_URL.'assets/admin/js/settings-tabs.js', array( 'jquery' ));
        wp_register_style('settings_tabs', QA_PLUGIN_URL.'assets/admin/css/settings-tabs.css');
