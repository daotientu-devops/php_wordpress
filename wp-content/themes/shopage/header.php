...
<head>
    ...
    <?php wp_head(); ?>
    <meta property="fb:app_id" content="2703846709893705" />
</head>

<body <?php body_class(); ?>>
<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v8.0&appId=2703846709893705&autoLogAppEvents=1" nonce="XbMXNL9X"></script>
<div class="fb-comments" data-href="http://125.212.224.111/wordpress" data-numposts="5" data-width=""></div>
<?php
...
<div id="page" class="site">
    <a class="skip-link screen-reader-text" href="#content"><?php esc_html_e('Skip to content', 'shopage'); ?></a>
        ...
        <?php if (class_exists('WooCommerce')) : ?>
            ...
            if ($show_main_banner_section): ?>
                ...
                <section class="main-banner-section-wrapper container-wrapper">
                    <?php shopical_get_block('5', 'main-banner'); ?>
                </section>
            <?php endif; ?>
